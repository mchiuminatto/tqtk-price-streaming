...
(recorded beside the values in `deploy/calibration/calibration.redis`)
...
(recorded beside the values in `deploy/calibration/calibration.redis`); every symbol rejected the implicit "spread is roughly constant"
